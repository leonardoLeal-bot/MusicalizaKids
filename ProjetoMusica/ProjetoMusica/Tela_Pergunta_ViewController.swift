...
class Tela_Pergunta_ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if nivel_selecionado == 1 && instrumento_selecionado == 2{
            obj = Question(texto: "Quem esta tocando o Piano?", opcao1: "pianista", opcao2: "baterista", opcao3: "saxofonista1", opcao4: "trompetista", resposta: 1)
        }
        if nivel_selecionado == 2 && instrumento_selecionado == 2{
            obj = Question(texto: "Qual destes é o GrandPiano", opcao1: "pianista", opcao2: "pianoEletronico", opcao3: "GrandPiano", opcao4: "piano_icon", resposta: 3)
        }
        if nivel_selecionado == 3 && instrumento_selecionado == 2{
            obj = Question(texto: "Qual deste é um Piano Eletrônico??", opcao1: "violino", opcao2: "pianoEletronico", opcao3: "trompete", opcao4: "guitarra", resposta: 2)
        }
            
        //VIOLAO
        if nivel_selecionado == 1 && instrumento_selecionado == 3{
            obj = Question(texto: "Qual destes é o violão?", opcao1: "guitarra", opcao2: "", opcao3: "", opcao4: "violao", resposta: 4)
        }
        ...
        if nivel_selecionado == 1 && instrumento_selecionado == 4{
            obj = Question(texto: "Qual destes é um Trompete?", opcao1: "", opcao2: "", opcao3: "", opcao4: "", resposta: 3)
        }
        if nivel_selecionado == 2 && instrumento_selecionado == 4{
            obj = Question(texto: "Quem é o trompetista?", opcao1: "", opcao2: "", opcao3: "", opcao4: "", resposta: 4)
        }
        if nivel_selecionado == 3 && instrumento_selecionado == 4{
            obj = Question(texto: "Do que normalmente são feitos os trompetes??", opcao1: "terraxas", opcao2: "violino", opcao3: "trompete_icon", opcao4: "", resposta: 4)
        }
